...
public class ExampleBoards {
    ...
    public static BoardModel getExample2() {
        ...
        // Column 0
        boardModel.setDot(new DotModel(0, 0, Color.BLUE));
        boardModel.setDot(new DotModel(0, 1, Color.GREEN));
        boardModel.setDot(new DotModel(0, 2, Color.RED));
        ...
        boardModel.setDot(new DotModel(1, 1, Color.RED));
        boardModel.setDot(new DotModel(1, 2, Color.RED));
        boardModel.setDot(new DotModel(1, 3, Color.YELLOW));
        boardModel.setDot(new DotModel(1, 4, Color.BLUE));
        ...
        boardModel.setDot(new DotModel(3, 5, Color.RED));

        // Column 4
        boardModel.setDot(new DotModel(4, 0, Color.BLUE));
        boardModel.setDot(new DotModel(4, 1, Color.GREEN));
        boardModel.setDot(new DotModel(4, 2, Color.RED));
        boardModel.setDot(new DotModel(4, 3, Color.RED));
        ...
        boardModel.setSelectionModel(null);
